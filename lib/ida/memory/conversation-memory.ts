...
/** Build LangChain conversation memory context from prior messages */
...
/** Persist session messages to Supabase for cross-request memory */
...
/** Load prior session messages if client state is empty */
